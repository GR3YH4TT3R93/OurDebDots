...
### ⚠️ Fork Repo and replace git clone url with your own! ⚠️
    ...
    ## REPLACE THIS URL ⬇️
    git clone --bare --recurse-submodules https://github.com/GR3YH4TT3R93/OurDebDots.git ~/GitHub/dotfiles
    ## REPLACE THIS URL ⬆️
    ...
    ## THE NEXT LINE AUTOMATICALLY RUNS THE AUTO-INSTALLER
    ## REMOVE IF YOU WANT TO RUN IT MANUALLY
    ~/autoinstall.sh

## Clone Dotfiles as Normal Repo

    git clone --recurse-submodules https://github.com/GR3YH4TT3R93/OurDebDots.git ~/
